...
PipelineQuaternionToRPY::PipelineQuaternionToRPY(void)
{
  ...
  amcl_pose_pub_ = nodehandle_.advertise<cultureid_devel::PoseRPYWithCovarianceStamped>(
    "/amcl_pose_rpy", 1);
  icp_pose_pub_ = nodehandle_.advertise<cultureid_devel::PoseRPYWithCovarianceStamped>(
    "/pipeline_laser_scan_matcher_node/pipeline_icp_corrected_pose_rpy", 1);
  dft_pose_pub_ = nodehandle_.advertise<cultureid_devel::PoseRPYWithCovarianceStamped>(
    "/pipeline_laser_scan_matcher_node/pipeline_corrected_pose_rpy", 1);
  gt_pose_pub_ = nodehandle_.advertise<cultureid_devel::PoseRPYWithCovarianceStamped>(
...
{
  cultureid_devel::PoseRPYWithCovarianceStamped mes = convert(msg);
...
void PipelineQuaternionToRPY::gtPoseCallback(const nav_msgs::Odometry& msg)
{
  ...
  cultureid_devel::PoseRPYWithCovarianceStamped mes = convert(pwcs);
...
/*******************************************************************************
 */
cultureid_devel::PoseRPYWithCovarianceStamped PipelineQuaternionToRPY::convert(
  const geometry_msgs::PoseWithCovarianceStamped& msg)
{
  tf::Quaternion q(
  ...
  cultureid_devel::PoseRPYWithCovarianceStamped mes;
