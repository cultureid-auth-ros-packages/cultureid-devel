...
output_file_path = rospkg.RosPack().get_path('cultureid_devel')+"/src/follow_waypoints/saved_path/pose.csv"
loaded_file_path = rospkg.RosPack().get_path('cultureid_devel')+"/src/follow_waypoints/loaded_path/pose.csv"
waypoints = []
